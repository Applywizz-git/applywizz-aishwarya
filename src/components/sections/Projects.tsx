...
import project4 from '@/assets/project44.jpeg';
import project5 from '@/assets/project55.jpeg';
import project6 from '@/assets/project66.jpeg';
...
export const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-10 bg-gradient-subtle relative overflow-hidden">
