...
export const Certification: React.FC = () => {
  ...
  return (
    <section id="certification" className="py-20 bg-gradient-subtle">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="p-2 rounded-full bg-charcoal hover:bg-teal-accent hover:text-ink-navy transition-smooth focus-ring"
